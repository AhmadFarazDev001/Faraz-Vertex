...
export default function Hero() {
  ...
  return (
    <section className="relative w-full h-[100vh] overflow-hidden">
      ...
      {/* Logo */}
      <div className="absolute top-4 left-1/2 -translate-x-1/2 md:translate-x-0 md:top-12 md:left-12 z-20 flex items-center gap-3">
        <svg width="24" height="24" viewBox="0 0 100 100" className="fill-[#E6DCC8]">
          <path d="M20 20 L50 80 L80 20 H60 L50 50 L40 20 Z" />
        </svg>
        <span className="font-body text-xs md:text-sm tracking-[0.4em] uppercase text-white/80 mt-1">VeldCraft</span>
      </div>
