/**
 * Centralized constant definitions for the VELDCRAFT web application.
...
export const MATERIALS_DATA = [
  {
    ...
    image: '/images/italian_calfskin.webp'
  },
  {
    id: '02',
    ...
    image: '/images/carbon_fiber.webp'
  },
  {
    id: '03',
