...
export const Specs: React.FC = () => {
  return (
    <section id="engineering" className="bg-crest-black py-16 md:py-24 lg:py-32">
      <div className="px-6 md:px-12 lg:px-20 max-w-[1600px] mx-auto">
        ...
        <div className="max-w-3xl">
          ...
          <FadeIn delay={0.4}>
            <p className="text-base text-crest-sand/70 font-body font-light mt-6 max-w-lg">
          ...
          <FadeInStaggerGroup className="flex gap-6 min-w-max">
            {specsData.map((spec, idx) => (
              <FadeInStaggerItem key={idx}>
                <div className="liquid-glass-dark rounded-[1.5rem] p-8 w-[320px] md:w-[380px] snap-center flex flex-col gap-4 border border-crest-white/5 hover:border-crest-white/10 transition-colors">
                  ...
                  <div>
                    <h4 className="font-heading italic text-crest-white text-2xl tracking-[-1px]">
                      {spec.name}
                    </h4>
                    <div className="text-4xl font-heading italic text-crest-ember leading-none mt-2">
                      {spec.value}
                    </div>
                  </div>
                  
                  <p className="text-sm text-crest-sand/70 font-body font-light mt-2 max-w-[28ch] leading-relaxed">
                    {spec.desc}
                  </p>
