...
export const Philosophy: React.FC = () => {
  return (
    <section id="about" className="min-h-[100dvh] bg-crest-charcoal relative">
      <div className="max-w-[1600px] mx-auto grid lg:grid-cols-2 items-center gap-10 md:gap-16 px-6 md:px-12 lg:px-20 py-16 md:py-24 lg:py-32">
        ...
        <div className="flex flex-col">
          ...
          <BlurText 
            text={"Crafted by\nhand, proven\nby gravity."} 
            className="font-heading italic text-crest-white text-[clamp(2.5rem,5vw,4.5rem)] leading-[0.9] tracking-[-2px]" 
          />

          <FadeInStaggerGroup className="mt-8 flex flex-col gap-4 max-w-lg">
            <FadeInStaggerItem>
              <p className="text-base text-crest-sand/70 font-body font-light leading-relaxed">
                We don't mass-produce. Every CREST FORGE mountain bike begins as a conversation: your riding style, your local terrain, your goals. From there, our master welders shape aerospace-grade titanium and carbon fiber into a frame built specifically for you.
              </p>
            </FadeInStaggerItem>
            <FadeInStaggerItem>
              <p className="text-base text-crest-sand/70 font-body font-light leading-relaxed">
          ...
          <FadeInStaggerGroup className="mt-8 flex flex-wrap gap-3">
            {['Titanium & Carbon', 'Custom Geometry', 'X-Ray Verified Welds', '11-Layer Paint', 'Lifetime Warranty'].map((pill) => (
              <FadeInStaggerItem key={pill}>
                <div className="liquid-glass rounded-full px-4 py-2 text-xs text-crest-white/80 font-body">
                  {pill}
                </div>
              </FadeInStaggerItem>
            ))}
        ...
        <FadeIn delay={0.3} className="h-full">
          <div className="relative rounded-[2rem] overflow-hidden group h-[600px] lg:h-full min-h-[500px]">
            ...
            />
            <div className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-crest-charcoal to-transparent pointer-events-none" />
          </div>
        </FadeIn>
