...
- **Cinematic Aesthetics:** A custom dark theme ("Crest Black", "Crest Charcoal") paired with a vibrant "Ember" accent color to create a rugged yet premium feel.
