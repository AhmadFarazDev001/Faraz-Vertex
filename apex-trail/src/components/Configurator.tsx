  ...
  return (
    <section id="build-yours" className="min-h-[100dvh] bg-apex-black py-16 md:py-24 px-6 md:px-12 lg:px-20 flex flex-col items-center">
      ...
      <div className="text-center max-w-3xl mx-auto">
        ...
        <FadeIn delay={0.4}>
          <p className="text-base text-apex-sand/70 font-body font-light mt-6">
      ...
      <FadeIn delay={0.6} className="w-full max-w-5xl mt-12 md:mt-16">
        <div className="liquid-glass-dark rounded-[2rem] p-8 md:p-12 border border-apex-white/5">
              ...
              <button
                ...
                className={`liquid-glass rounded-xl p-4 text-left transition-all duration-300 border ${
                  selections[activeTab] === option.id 
                    ? 'border-apex-ember shadow-[0_0_15px_rgba(232,85,42,0.2)]' 
                    : 'border-transparent hover:border-apex-white/20'
                }`}
              >
                <div className="text-sm font-body font-semibold text-apex-white">{option.name}</div>
                <div className="text-xs font-body text-apex-sand/60 mt-1 flex justify-between items-center">
                  <span>{option.detail}</span>
                  {option.price !== 0 && (
                    <span className="text-apex-ember">
          ...
          <div className="mt-8 flex flex-col items-end">
            <span className="text-xs text-apex-sand/60 font-body">Starting from</span>
            <span className="text-4xl font-heading italic text-apex-ember">
