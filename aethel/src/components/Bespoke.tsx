...
export default function Bespoke() {
  return (
    <section id="bespoke" className="relative min-h-[100dvh] w-full bg-background flex flex-col md:flex-row items-center justify-center p-8 md:p-24 overflow-hidden border-t border-white/5">
      <div className="w-full md:w-1/2 z-10 flex flex-col justify-center items-start space-y-8 pr-0 md:pr-24">
        <div className="text-white/50 font-body text-xs tracking-[0.4em] uppercase">The Bespoke Experience</div>
        <h2 className="text-5xl md:text-8xl font-display text-foreground leading-tight">Measured for <br/><span className="italic text-muted-foreground">Perfection.</span></h2>
      ...
      <div className="w-full md:w-1/2 h-[60vh] md:h-[80vh] relative mt-12 md:mt-0 group">
        <div className="absolute inset-0 liquid-glass rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-white/5">
           <img src="/images/artisan_hands.png" alt="Artisan Hands" className="w-full h-full object-cover opacity-80 mix-blend-luminosity group-hover:mix-blend-normal transition-all duration-1000 group-hover:scale-105" />
        </div>
      </div>
    </section>
  )
