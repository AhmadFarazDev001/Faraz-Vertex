...
export default function Footer() {
  return (
    <footer className="relative min-h-[60vh] w-full bg-background flex flex-col justify-between overflow-hidden pt-32 pb-8 border-t border-white/5">
      <div className="container mx-auto px-6 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 z-10">
      ...
      <div className="w-full flex flex-col mt-auto pt-24 relative">
        ...
        <div className="relative w-full flex flex-col md:flex-row justify-between items-center px-6 md:px-8 text-[10px] text-white/30 uppercase tracking-[0.3em] font-body z-20 mt-4 md:mt-0 md:translate-y-[1rem]">
